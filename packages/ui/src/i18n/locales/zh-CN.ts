...
const zhCN: Record<string, string> = {
  ...
  "chat.contextMenu.title": "任务内容菜单",
  "chat.contextMenu.exportMarkdownFull": "另存所有为 Markdown…",
  "chat.contextMenu.exportMarkdown": "另存为 Markdown…（精简）",
  "chat.contextMenu.exportBusy": "正在导出…",
  "chat.contextMenu.zoomIn": "放大",
  "chat.contextMenu.zoomOut": "缩小",
  "chat.contextMenu.zoomLevel": "缩放 {percent}%",
  "chat.contextMenu.zoomReset": "重置缩放",
  "chat.export.exportedAt": "导出于 {time} · 共 {turns} 轮",
  "chat.export.turnHeading": "第 {index} 轮 · {origin} · {time}",
  "chat.export.origin.user": "用户",
  "chat.export.origin.goalContinuation": "目标延续",
  "chat.export.origin.backgroundResult": "后台结果",
  "chat.export.origin.editRerun": "编辑重跑",
  "chat.export.origin.workflowLaunch": "工作流启动",
  "chat.export.section.user": "用户",
  "chat.export.section.systemInput": "系统输入",
  "chat.export.section.reasoning": "思考过程",
  "chat.export.section.assistant": "回复",
  "chat.export.section.toolCall": "工具调用：{name}",
  "chat.export.workedFor": "已工作 {duration}",
  "chat.export.duration.minutesSeconds": "{minutes} 分 {seconds} 秒",
  "chat.export.duration.seconds": "{seconds} 秒",
  "chat.export.attachment": "附件：{name}（{mime}，{sizeLabel}）",
  "chat.export.screenshot": "截图 {index}",
  "chat.export.imageUnavailable": "图片不可用",
  "chat.export.inputTruncated": "（输入已截断）",
  "chat.export.toolFailedShort": "失败：{message}",
  "chat.export.toast.success": "已保存：{path}",
  "chat.export.toast.failed": "导出失败，请重试",
  "chat.export.toast.empty": "当前任务没有可导出的内容",
  "chat.export.toast.tooLarge": "导出内容过大，无法保存",
  "chat.stop": "停止生成",
  "chat.stop.short": "停止",
